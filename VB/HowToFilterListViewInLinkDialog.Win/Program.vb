...
Imports HowToFilterListViewInLinkDialog.Win
...
Public Class Program
    ...
    Public Shared Sub Main(ByVal arguments() As String)
        ...
        Dim _application As HowToFilterListViewInLinkDialogWindowsFormsApplication = New HowToFilterListViewInLinkDialogWindowsFormsApplication()
