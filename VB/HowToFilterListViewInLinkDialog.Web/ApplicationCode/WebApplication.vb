...
Namespace HowToFilterListViewInLinkDialog.Web
   Partial Public Class HowToFilterListViewInLinkDialogAspNetApplication
	   Inherits WebApplication
	  Private module1 As DevExpress.ExpressApp.SystemModule.SystemModule
	  Private module2 As DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule
	  Private module3 As HowToFilterListViewInLinkDialog.Module.HowToFilterListViewInLinkDialogModule
	  Private module4 As HowToFilterListViewInLinkDialog.Module.Web.HowToFilterListViewInLinkDialogAspNetModule
	  ...
	  Private Sub HowToFilterListViewInLinkDialogAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
	  ...
	  Private Sub InitializeComponent()
		 ...
		 Me.module3 = New HowToFilterListViewInLinkDialog.Module.HowToFilterListViewInLinkDialogModule()
		 Me.module4 = New HowToFilterListViewInLinkDialog.Module.Web.HowToFilterListViewInLinkDialogAspNetModule()
		 ...
		 ' sqlConnection1
		 ' 
		 Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=HowToFilterListViewInLinkDialog;Integrated Security=SSPI;Pooling=false"
		 Me.sqlConnection1.FireInfoMessageEventOnUserErrors = False
		 ' 
		 ' HowToFilterListViewInLinkDialogAspNetApplication
		 ' 
		 Me.ApplicationName = "HowToFilterListViewInLinkDialog"
...
'		 Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.HowToFilterListViewInLinkDialogAspNetApplication_DatabaseVersionMismatch);
